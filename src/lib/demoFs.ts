...
export function seedDemo() {
  ...
  put(`${r}/.atlas/local-news/current.json`, JSON.stringify({
    ...
    events: [{
      section: "Festival & Photo Watch",
      title: "Lantern river festival fills the old quay",
      summary: "Neighborhood groups launch handmade lanterns after an evening of drumming and food stalls.",
      source: "River City Cultural Office",
      url: "https://example.com/lantern-festival",
      date: today,
      time: "17:30",
      venue: "Old Quay Promenade, River City",
      photoOpportunity: "Arrive before sunset for lantern makers at work, then photograph the blue-hour launch from the east bank.",
      logistics: "Riverfront parking closes at 16:00; use the tram. Tripods are allowed outside the marked performance lane.",
